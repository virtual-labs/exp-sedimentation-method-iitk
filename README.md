...
This experiment involves determining the particle size and particle size distribution using the sedimentation method with an Andreasen Pipette. It is based on the principle that particles settle at different rates depending on their size and density. The analysis helps in understanding the fineness, uniformity, and behavior of powders or suspensions, which is essential for process control and product quality in pharmaceutical and chemical industries.
...
5 |Daksh Raj Singh| Student| Department of Mathematics statistics and Computer Application | BU Jhansi |dakshlikekings@gmail.com
